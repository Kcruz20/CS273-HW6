...
protected:
	...
	std::string get_fees()
	{
		...
		charge = customer->get_check_chrg();
		overdraft = customer->get_overdraft();
...
protected:
	...
	*/
	void add_interest(double interest) {
		...
		tran = new Transaction(customer->get_id(), "Added Interest", amt, fees);
...
public:
	...
	*/
	virtual std::string to_string() {
		...
		ss << "  Customer ID: " << customer->get_id() << '\n';
	...
	*/
	virtual void deposit(double amt) {
		...
		tran = new Transaction(customer->get_id(), "Deposit", amt, fees);
	...
	*/
	virtual void withdraw(double amt) {
		...
		tran = new Transaction(customer->get_id(), "Withdrawal", amt, fees);
